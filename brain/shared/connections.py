"""DB Connection Factories — Shared Kernel

Singleton Connection Manager fuer alle Datenbanken.
Lazy initialization: Verbindung erst bei erstem Zugriff.
...
from brain.shared.config import load_config, get_brain_dir
...
def get_sqlite():
    ...
    db_path = Path(get_brain_dir()) / "recall_memory" / "conversations.db"
